...
function ContainerWindow.LegacyGridDock(this)
	...
	if (not UserContainerSettings.gridLegacy()) then
		...
		if ( gumpID == 65 ) or (gumpID == 40167) then
		...
		if ((gumpID == 75) or (gumpID == 9834) or (gumpID == 9835)) then
			ContainerWindow.Grid.PaddingTop = 170
			ContainerWindow.Grid.PaddingLeft = 12
			ContainerWindow.Grid.PaddingBottom = 15
			ContainerWindow.Grid.PaddingRight = 50
		...
		if ( (gumpID == 78) or (gumpID == 39934) ) then
		...
		if ((gumpID == 266) or (gumpID == 267) or (gumpID == 260)
		 or (gumpID == 261) or (gumpID == 262) or (gumpID == 263)
		 or (gumpID == 265) or (gumpID == 268) or (gumpID == 269)
		 or (gumpID == 270) or(gumpID == 40153)) then
			ContainerWindow.Grid.PaddingTop = 85
			ContainerWindow.Grid.PaddingLeft = 12
			ContainerWindow.Grid.PaddingBottom = 15
			ContainerWindow.Grid.PaddingRight = 40
		...
		if ( (gumpID == 282) or (gumpID == 1747) or (gumpID == 1748) or (gumpID == 1749) or (gumpID == 1750) or (gumpID == 40247) or (gumpID == 40248) or (gumpID == 40249) or (gumpID == 40250))then
		...
		if ( gumpID == 284 or gumpID == 290 ) then
		...
		if ( gumpID == 291 ) then
			ContainerWindow.Grid.PaddingTop = 60
			ContainerWindow.Grid.PaddingLeft = 12
			ContainerWindow.Grid.PaddingBottom =0
			ContainerWindow.Grid.PaddingRight = 56
			ContainerWindow.Grid.BlackText = false
			ContainerWindow.List.PaddingTop = 60
			ContainerWindow.List.PaddingLeft = 0
			ContainerWindow.List.PaddingBottom = 0
			ContainerWindow.List.PaddingRight = 46
			ContainerWindow.List.BlackText = false

			LabelSetTextColor (this.."Title", 255,26,31)
			WindowSetDimensions( this, (xSize * scale), (ySize * scale) )
			WindowAddAnchor( this.."ViewButton", "top", this, "center", 36, 340)
			WindowAddAnchor( this.."GridView", "topleft", this, "topleft", 50, 28)
			WindowAddAnchor( this.."ListView", "topleft", this, "topleft", 50, 28)
		end


			
		if ( (gumpID == 1156) or (gumpID == 40276) ) then
			ContainerWindow.Grid.PaddingTop = 170
			ContainerWindow.Grid.PaddingLeft = 12
			ContainerWindow.Grid.PaddingBottom = 15
			ContainerWindow.Grid.PaddingRight = 50
		...
		if ( gumpID == 30586 ) then
				ContainerWindow.Grid.PaddingTop = 180
				ContainerWindow.Grid.PaddingLeft = 25
				ContainerWindow.Grid.PaddingBottom = 22
				ContainerWindow.Grid.PaddingRight = 60
				ContainerWindow.Grid.BlackText = true
				ContainerWindow.List.PaddingTop = 180
				ContainerWindow.List.PaddingLeft = 25
				ContainerWindow.List.PaddingBottom = 22
				ContainerWindow.List.PaddingRight = 60
				ContainerWindow.List.BlackText = true
				
				LabelSetTextColor (this.."Title", 255,26,31)
				WindowSetDimensions( this, (xSize * scale), (ySize * scale) )
				WindowAddAnchor( this.."ViewButton", "bottom", this, "center", 0, -140)
				WindowAddAnchor( this.."GridView", "topleft", this, "topleft", 50, 0)				
				WindowAddAnchor( this.."ListView", "topleft", this, "topleft", 50, 0)
